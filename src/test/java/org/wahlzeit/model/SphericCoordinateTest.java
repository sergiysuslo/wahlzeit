...
public class SphericCoordinateTest {
    ...
    @Before
    public void setup(){
        coord_1  = new SphericCoordinate(1.11, 22.44, 345.3);
        coord_2  = new SphericCoordinate(3.11, 26.44, 345.3);
        coord_3  = new SphericCoordinate(1.0, 2.0, 3.0);
        coord_4  = new SphericCoordinate(1.0, 2.0, 3.0);
    }
    @Test
    ...
    public void testCartesianDistance(){
        ...
        coord_5 = new SphericCoordinate(5, 500, 20);
        coord_6 = new SphericCoordinate(5, 500, 22);
    ...
    public void testEquals(){
        ...
        cart_coord_5 = coord_3.asCartesianCoordinate();

        assertFalse(cart_coord_5.equals(coord_1));
        assertTrue(coord_4.equals(cart_coord_5));
